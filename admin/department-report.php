                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                                            ...
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-gray-700 fw-bold lh-1">विभाग अहवाल
                                            </li>
                                            <!--end::Item-->
                                        </ul>
                                        <!--end::Breadcrumb-->
...
// ✅ SELECT में date निकाला
$sql = "SELECT departmentName, description, DATE(createdDateTime) AS dateOnly FROM departments";

$q = mysqli_query($conn, $sql) or die("SQL Error: " . mysqli_error($conn));
?>
    ...
    <tbody class="fw-semibold text-black-800">
        <?php while ($r = mysqli_fetch_assoc($q)) { ?>
            <tr class="odd">
                ...
                <td><?= $r['description']; ?></td>
                <td><?= $r['dateOnly']; ?></td> <!-- ✅ now will work -->
            </tr>
        <?php } ?>
    </tbody>
</table>
