                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    $stmt = $conn->prepare("
                                                        SELECT 
                                                            ...
                                                            a.landDesc, a.taluka, a.village, a.gatNo, a.mobileNo, a.emailId, a.status,
                                                            a.createdDateTime, a.inspectionOfficer,a.init_status, a.final_status,a.final_remark,a.init_remark
                                                        FROM departmentNocApplications a
                             ...
                             <td style="white-space: nowrap;">
                                ...
                                <div class="modal fade" id="updateStatusModal<?= $row['applicationId']; ?>" tabindex="-1"
                                  ...
                                  <div class="modal-dialog">
                                    <form method="POST" action="department/department_ReportFAuthFinalDB.php"
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          <input type="hidden" name="final_status" value="Forwarded">
