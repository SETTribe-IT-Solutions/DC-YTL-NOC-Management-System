...
<head>
    <base href="../">
    <title>NOC अर्ज पहा (Department)</title>
    <meta charset="utf-8" />
                                                ...
                                                <div class="col-md-3 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <input class="form-control" name="startDate"
                                                            placeholder="सुरुवात तारीख" id="kt_datepicker_1" />
                                                    </div>
                                                </div>
                                                <!--end::Col-->
                                                ...
                                                <div class="col-md-3 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        <input class="form-control form-control-solid" name="endDate"
                                                            placeholder="अंतिम तारीख" id="kt_datepicker_2" />
                                                    </div>
                                                </div>
                                                <!--end::Col-->
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade"
                                                                    ...
                                                                    tabindex="-1" aria-labelledby="updateStatusModalLabel"
                                                                    aria-hidden="true">
