...
<!--begin:Menu item-->
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion">
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link" href="department/SDO_noc_civilian.php" 
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link" href="department/SDO_noc_department.php"
                   data-bs-toggle="tooltip" data-bs-trigger="hover" 
                   data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
    ...
    <!--end:Menu item-->
            ...
            ?>
            <?php
if ($_SESSION['systemRole'] == "Tahsildar") {
?>
    <!--begin:Menu item-->
    <!-- <div class="menu-item" onclick="window.location.href='officers/tahsildar-dashboard.php'">
        <span class="menu-link">
    ...
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion">
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link" href="department/tashildar_noc_department.php"
                   data-bs-toggle="tooltip" data-bs-trigger="hover" 
                   data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
