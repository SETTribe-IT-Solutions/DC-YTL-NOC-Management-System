        ...
        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
            ...
            if ($designation == 'Civilian') {
                ...
                ?>
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item" onclick="window.location.href='officers/nocReport.php'">
                                <!--begin:Menu link-->
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item" onclick="window.location.href='officers/nocApplicationDept.php'">
                                <!--begin:Menu link-->
