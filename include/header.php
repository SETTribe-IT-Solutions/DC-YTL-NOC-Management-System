    ...
    <div class="d-flex align-items-center flex-stack flex-grow-1">
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="assets/media/avatars/svg/009-boy-4.svg" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                            <span class="fs-6 fw-semibold"><?php echo $_SESSION['name'] ?></span>
                                            <span
                                                class="fs-7 fw-semibold text-muted"><?php echo $_SESSION['designation'] ?></span>
                                        </div>
                                        <!--end::Title-->
                                    </a>
                                    <!--end::Item-->
        ...
        <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-30px symbol-lg-40px"
                ...
                <img src="assets/media/svg/avatars/009-boy-4.svg" alt="user" />
            </div>
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="assets/media/svg/avatars/009-boy-4.svg" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                        <div class="d-flex flex-column">
                            ...
                            <a href="#"
                                class="fw-semibold text-muted text-hover-primary fs-7"><?php echo $_SESSION['designation'] ?></a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
